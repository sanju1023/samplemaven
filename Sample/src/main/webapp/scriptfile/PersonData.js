...
alert(JSON.stringify(jAjx));
	$.ajax({
		url : 'http://samplemavenapp.herokuapp.com/personDetails',
		type : 'POST',
...
function viewList() {
	...
	$.ajax({
				url : 'http://samplemavenapp.herokuapp.com/tablevalues',
				type : 'GET',
...
function deletedata(dlt) {
	...
	if (dr == true) {
		...
		$.ajax({
			url : 'http://samplemavenapp.herokuapp.com/deleteperson',
			type : 'DELETE',
			contentType : 'application/json',
...
function savebtn(sd) {
	...
	$.ajax({
		url : 'http://samplemavenapp.herokuapp.com/editperson',
		type : 'PUT',
		contentType : 'application/json',
